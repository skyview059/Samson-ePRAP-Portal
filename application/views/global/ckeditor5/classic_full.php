...
<script type="text/javascript">
    ClassicEditor
        .create(document.querySelector('<?= $selector; ?>'), {
            ...
            toolbar       : {
                items                 : [
                    'heading', 'fontFamily', 'fontSize', 'fontColor', 'fontBackgroundColor', 'highlight', 'bold', 'italic',
                    'underline', 'link', 'bulletedList', 'numberedList', 'alignment', 'outdent', 'indent', 'ckfinder', 'imageUpload',
                    'insertTable', 'blockQuote', 'undo', 'redo', 'findAndReplace', 'horizontalLine', 'pageBreak', 'sourceEditing'
                ],
