...
<div class="row" style="padding-bottom: 15px">
    <div class="col-md-6">
        <h3 style="font-weight: 700; color: #6C00A1">Study Plan<small> / Create</small></h3>
    </div>
    <div class="col-md-6 text-right">
        <a href="<?php echo site_url('study-plan'); ?>" class="btn btn-default">Back</a>
    </div>
</div>
...
<script>
    $('#exam_id').on('change', function () {
        ...
        location.href        = '<?= site_url('study-plan/create'); ?>?exam_id=' + valueSelected;
    });

    $('#subject_id').on('change', function () {
        const valueSelected  = this.value;
        location.href        = '<?= site_url('study-plan/create'); ?>?exam_id=<?= $exam_id; ?>&subject_id=' + valueSelected;
    });

    $('#topic_id').on('change', function () {
        const valueSelected  = this.value;
        location.href        = '<?= site_url('study-plan/create'); ?>?exam_id=<?= $exam_id; ?>&subject_id=<?= $subject_id; ?>&topic_id=' + valueSelected;
    });
