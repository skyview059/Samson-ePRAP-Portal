...
<div class="booking-tab">
    <div class="tab-content">
        ...
        <div class="payment_details">
            <h3>Dear Student,</h3>
            <p><?php getInvoiceCourses($cart_id); ?></p>
            <p>You have Selected <?= $item_qty; ?> courses/practices. <br>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="row">
                    <?php
                    if ( $this->config->item('paypal_enable')){ ?>
                    ...
                    <!--End::paypal payment-->
                    <?php } else { echo '<div class="col-md-3"></div>';} ?>

                    <?php
                        if ( $this->config->item('stripe_enable')){ ?>
...
<!--                    </div>-->
                ...
                <br clear="all"/>
                <p>If you are not able to Pay by Card,<br/>
                ...
                please contact <?php // $SiteName; ?> <br/>
                Phone: <?php // $PhoneNumber; ?> <br/>
                Email <?php // $IncomingEmail; ?> <br/>
                to arrange your booking.</p> -->
            </div>
        </div>
