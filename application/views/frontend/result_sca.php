...
<?php
/**
 * Student portal — SCA exam result report.
 * Student-facing version of admin assess/result/details_sca.php.
 * Expects the standard result vars plus $exam_pass_mark and $sca
 * (built by sca_build_report() in the assess result helper):
...
$download_link = site_url('results/download/' . $results->exam_schedule_id);
?>
<style type="text/css">
    ...
    .sca-footer .btn { margin: 0 6px 8px; }
...
<div class="sca-report">
    ...
    <div class="sca-back"><a href="<?php echo site_url('results'); ?>">&laquo; Back to my results</a></div>
    ...
    <div class="sca-card">
        ...
        <div class="sca-summary">
            ...
            <div>Pass mark: <strong><?php echo $fmt_score($exam_pass_mark); ?></strong></div>
    ...
    <div id="individual-feedback" class="sca-card">
        ...
        <p class="sca-intro" style="margin:0">The <?php echo $stations; ?> case<?php echo $stations == 1 ? '' : 's'; ?> taken in your SCA <?php echo $stations == 1 ? 'is' : 'are'; ?> detailed below. These include the individual grades you received per marking domain, any feedback statements selected by the examiner, and the examiner&rsquo;s comments.</p>
    </div>
    ...
    <div class="sca-footer">
        <a href="<?php echo site_url('results'); ?>" class="btn btn-lg btn-default">
            <i class="fa fa-fw fa-arrow-left"></i>
            Back to Results
        </a>
        <a href="<?php echo $download_link; ?>" class="btn btn-lg btn-primary">
