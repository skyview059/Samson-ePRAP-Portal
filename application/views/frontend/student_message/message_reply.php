<div class="panel panel-default" style="display: none; margin-top: 15px" id="reply_box">
    <div class="panel-heading">Reply to Message</div>
    <div class="panel-body">
        <form name="reply" id="reply" method="post"
              action="<?php echo site_url('student-messages/message_reply_action'); ?>">
            <input type="hidden" name="parent_id" value="<?php echo $parent_id; ?>"/>
            <input type="hidden" name="user_id" value="<?php echo $to_student_id; ?>"/>
            <div class="box-body">
