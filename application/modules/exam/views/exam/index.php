...
<section class="content-header">
    <h1> <?php echo getExamName($id); ?> Mock Exam Dates 
        <small>Control panel</small> 
        <?php 

            echo anchor(
                site_url(Backend_URL . 'exam/create?id='. $id ), 
                '<i class="fa fa-plus"></i> Add New Mock Exam', 
...
<section class="content personaldevelopment">
    <?php echo examListTab( $tab, $coming, $past, $canceled ); ?>
    <div class="box no-border">
        <div class="box-header with-border">
            <h3 class="box-title">Mock Exam List</h3>
            <div class="col-md-3 col-md-offset-9 text-right hidden">
                <form action="<?php echo site_url(Backend_URL . 'exam'); ?>" class="form-inline" method="get">
        ...
        <div class="box-body">
            ...
            <?php if(!$exams){ ?>
                <p class="ajax_notice"> No Mock Exam Dates Found</p>                                
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <?php foreach ($exams as $exam) { ?>
                        <tr class="mc_<?= strtolower_fk($exam->exam_status); ?>">
                            ...
                            <td><?= Wa::hasWhatsApp($exam->id, 'Mock'); ?></td>
                            <td><?php 
                            ...
                            <td class="text-center">
                                <?php
                                echo anchor(site_url(Backend_URL . 'exam/update/' . $exam->id), '<i class="fa fa-fw fa-edit"></i> Edit', 'class="btn btn-xs btn-warning"');
                                echo anchor(site_url(Backend_URL . 'exam/scenario/' . $exam->id), '<i class="fa fa-exchange"></i> Scenario', 'class="btn btn-xs btn-warning"');
                                echo anchor(site_url(Backend_URL . 'exam/delete/' . $exam->id), '<i class="fa fa-fw fa-times"></i>', 'class="btn btn-xs btn-danger"');
                                ?>
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <span>Total Exam: <?php echo $total_rows; ?></span>
                </div>
