...
<?php load_module_asset('users', 'css'); ?>
    <section class="content-header">
        <h1>Mock Exam<small><?php echo $button ?></small></h1>
        <ol class="breadcrumb">
...
<?php load_module_asset('exam', 'css'); ?>
    <section class="content personaldevelopment"><?php echo examTabs($id, 'update'); ?>
        <div class="box no-border">
            <div class="box-header with-border">
                <h3 class="box-title">Update Mock Exam</h3>
                ...
                <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <a href="<?php echo site_url(Backend_URL . 'exam?id=' . $exam_id) ?>"
