...
<section class="content-header">
    <h1> Promo Codes <small><?php echo $button ?></small> <a href="<?php echo site_url(Backend_URL . 'promocodes') ?>"
...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Add New Promo Codes</h3>
        </div>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="number" class="form-control" name="uses_limit" id="uses_limit" placeholder="Uses Limit" value="<?= $uses_limit; ?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="number" class="form-control" name="amount" id="amount" placeholder="Amount" value="<?= $amount; ?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control js_datepicker" name="start_date" id="start_date" placeholder="Start Date" autocomplete="off" value="<?php echo $start_date; ?>" />
                    <?php echo form_error('start_date') ?>
                </div>

                <label for="end_date" class="col-sm-2 control-label">End Date :</label>
                <div class="col-sm-4 ">
                    <input type="text" class="form-control js_datepicker" name="end_date" id="end_date" placeholder="End Date" autocomplete="off" value="<?php echo $end_date; ?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="icheck-primary icheck-inline">
                        <input type="radio" name="status" value="Public" id="public" <?php echo $status == 'Public' ? 'checked' :'' ?> />
                        <label for="public"> Public </label>
                    </div>

                    <div class="icheck-primary icheck-inline">
                        <input type="radio" name="status" value="Draft" id="draft" <?php echo $status == 'Draft' ? 'checked' :'' ?> />
                        <label for="draft"> Draft </label>
                    </div>
                    <br><?php echo form_error('status') ?>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="icheck-primary icheck-inline" style="margin: 0 5px 20px!important">
                        <input type="checkbox" name="use_multiple" value="yes" id="use_multiple"/>
