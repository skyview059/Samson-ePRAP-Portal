...
<section class="content-header">
    <h1>Individual Learning Plan<small><?php echo $button ?></small></h1>
    <ol class="breadcrumb">
...
<section class="content">
    <?php // echo development_planTabs($id, 'update'); ?>
    <div class="panel panel-default">
  <div class="panel-heading">Update Individual Learning Plan</div>
  <div class="panel-body">
      <form class="form-horizontal" action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" autocomplete="off" class="form-control js_datepicker date_picker_icon"
                               name="date_of_achievement" id="date_of_achievement"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" autocomplete="off" class="form-control js_datepicker date_picker_icon" name="review_date"
                               id="review_date"
