...
<section class="content-header">
    <h1>Online Mock <small>Delete</small></h1>
    <ol class="breadcrumb">
...
<section class="content personaldevelopment">
    <?php echo onlineMockTabs($id, 'cancel'); ?>
    <div class="box no-border">
        ...
        <div class="box-footer">
            ...
            <?php if($datetime > date("Y-m-d H:i:s") && $exam_status=='Canceled'){?>
                ...
                <?php 
                echo anchor(
                    site_url(Backend_URL . 'online_mock/rollback_action/' . $id),
                ...
                echo anchor(
                    site_url(Backend_URL . 'online_mock/cancel_action/' . $id),
