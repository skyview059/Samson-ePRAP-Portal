<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
    ...
    <section class="content-header">
        <h1> Online Mock <small><?php echo $button ?></small>
            <a href="<?php echo site_url(Backend_URL . "online_mock?id={$exam_id}"); ?>" class="btn btn-default">
                Back
            </a>
        </h1>
        <ol class="breadcrumb">
...
<?php load_module_asset('online_mock', 'css'); ?>
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">Setup New Online Mock</div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="exam_centre_id" class="form-control" id="exam_centre_id" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <span class="input-group-addon">
                            ...
                            <input type="text" class="form-control js_datepicker" name="date" id="date"
...
Your scores of each station.</textarea>
                ...
                <?php /* ?>
                <style type="text/css"> select option:disabled {
                        color: #929292;
                        font-style: italic;
                    } </style>
