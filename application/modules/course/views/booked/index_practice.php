...
<section class="content-header">
    <h1> Practice Booking <small>Control panel</small>
        <a class="btn btn-primary" href="<?= Backend_URL; ?>course/booked/create_practice">
            + Book Practice as Admin
        </a>
    </h1>
...
<section class="content personaldevelopment">
    ...
    <?= practiceBookingTabAsStatus($status); ?>
    <div class="box no-border">
        <div class="box-header with-border">
            <!--<pre><?php // $sql; ?></pre>-->
            <?php $this->load->view('index_filter_practice'); ?>
        </div>
                ...
                <table class="table table-bordered table-striped table-condensed">
                    ...
                    <?php foreach ($bookeds as $booked) { ?>
                        <tr>
                            ...
                            <td><?= $booked->name; ?></td>
                            <td class="text-center"><?= $booked->gateway; ?></td>
                            <td class="text-right"><?= GBP($booked->paid); ?></td>
                            <td class="text-center"><?= deadline($booked->expiry_date); ?></td>
                            <td class="text-center"><?= isConfirmed($booked->status); ?></td>
        ...
        <form name="bookedPaymentModal" id="bookedPaymentModal">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="course_booked_id" id="course_booked_id" value="0"/>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.booked-cancel', function (e) {
        ...
        $('#cancelModal #course_booked_id').val(course_booked_id);
        $('#cancelModal #admin_txt').val($(this).data('note'));
        ...
        $.ajax({
            ...
            success   : function (respond) {
                if (respond.Status === 'OK') {
                    location.href = '<?= base_url('course/booked/practice'); ?>';
                } else {
    ...
    $('body').on('click', '.admin_note', function (e) {
        var course_booked_id = $(this).data('id');
        $('#admin_note #course_booked_id_an').val(course_booked_id);
        $('#admin_note #admin_note_txt').val($(this).data('note'));
