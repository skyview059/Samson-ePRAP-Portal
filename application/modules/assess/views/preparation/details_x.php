        ...
        <div class="box-header with-border">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="<?php echo site_url(Backend_URL . 'scenario/print/' . $id . '?is=instructions') ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Candidate Instructions</a>
