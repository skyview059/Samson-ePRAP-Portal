...
<section class="content personaldevelopment">
    <ul class="nav nav-tabs admintab">
        <li><a class="<?php echo ($this->input->get('most_login') != 'yes') ? 'active' : ''; ?>"
               href="<?php echo Backend_URL . 'student/login_history' ?>"> All</a></li>
        <li><a class="<?php echo ($this->input->get('most_login') == 'yes') ? 'active' : ''; ?>"
               href="<?php echo Backend_URL . 'student/login_history?most_login=yes' ?>"> Most Login Users</a></li>
    </ul>
                        ...
                        <form method="get" name="report" action="">
                            ...
                            <div class="col-md-7">
                                ...
                                <div id="custom" <?php echo ($ragne == 'Custom') ? '' : ' style="display: none;"'; ?>>
                                    <div class="col-md-3">
                                        <input type="text" name="fd" placeholder="From Date"
                                               value="<?php echo $this->input->get('fd'); ?>"
                                               class="form-control input-md dp_icon js_datepicker" autocomplete="off">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" name="td" placeholder="To Date"
                                               value="<?php echo $this->input->get('td'); ?>" size="10"
                                               class="form-control dp_icon input-md js_datepicker" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="button" class="btn btn-default" value="Reset"
                                               onclick="location.href = 'admin/student/login_history';">
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <table class="table table-striped table-bordered table-condensed">
                        ...
                        <?php foreach ($logins as $login) { ?>
                            <tr id="row_<?php echo $login->id; ?>">
                                ...
                                <td><a href="<?php echo Backend_URL . 'student/read/' . $login->student_id; ?>">
                                ...
                                <td class="text-center"><span class="btn btn-danger btn-xs delete"
                                                              ...
                                                              data-student="<?php echo $login->student_id; ?>">
                            ...
                            <div class="row" style="">
                                <div class="col-md-12">
                                    <div class="col-md-3 no-padding">
                                        <label class="btn btn-default"><input type="checkbox" name="checkall"
                                                                              onclick="checkedAll();"> Mark All</label>
                                    </div>
                                    ...
                                    <div class="col-md-2 no-padding">
                                        <button type="button" id="open_dialog" class="btn btn-primary btn-flat">Action
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    jQuery('#open_dialog').on('click', function () {
        ...
        jQuery.ajax({
            url: 'admin/student/login_history/bulk_action',
            type: "POST",
            dataType: "json",
            data: formData,
            beforeSend: function () {
    ...
    jQuery(document).on('click', '.delete', function () {
        ...
        var student = parseInt($(this).data('student')) || 0;
        var most = $(this).data('most');

        var yes = confirm('Confirm Delete');
        if (yes) {
            jQuery.ajax({
                url: 'admin/student/login_history/delete',
                type: "POST",
                dataType: "json",
                data: {id: id, most: most, student: student},
                beforeSend: function () {
