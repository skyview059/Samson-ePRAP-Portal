        ...
        jQuery.ajax({
            ...
            success: function (jsonRespond) {
                ...
                setTimeout(function () {
                    ...
                    location.href = '<?php echo Backend_URL  ?>users/roles';
                }, 2000);
            }
        });
        return false;
            ...
            jQuery.ajax({
                ...
                success: function (respond) {
                    if(respond.Status === 'OK'){
                        ...
                        jQuery('.role_id_' + id).css('background-color', 'none');
                    }
                }
            });
        }
        ...
        $("#update_user").on('submit', (function (e) {
            ...
            jQuery.ajax({
                ...
                success: function (msg) {
                    ...
                    setTimeout(function () {
                        jQuery('#success_report').fadeOut('slow');
                    }, 2000);
                },
                processData: false,
                contentType: false,
