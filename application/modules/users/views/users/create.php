...
<section class="content">
  ...
  <div class="panel-body">
      <form action="<?php echo Backend_URL; ?>users/create_action" method="post" id="user" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-2">Password :<sup>*</sup></label>
                    <div class="col-sm-4">
                        <div class="input-group">

                            <input type="text" maxlength="12" minlength="6"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (respond) {
                        if (respond.Status === 'OK') {
                            ...
                            $('#success_report').html(respond.Msg);
        ...
        $("#role_id").change(function () {
            var role_id = parseInt( $('#role_id').val() ) || 0;
            if (role_id === 7) {
                $("#show_occupation").slideDown("slow");
            } else {
                $("#show_occupation").slideUp("slow");
            }
        });
    });
</script>